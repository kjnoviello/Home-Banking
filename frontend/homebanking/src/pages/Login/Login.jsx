...
const Login = () => {
    ...
    return (
        <main className="main">
            ...
            <Input placeholder="Clave Segura" type="password" img="/icons/Vector.png" iconTrailing="/icons/trailing.png" iconTrailingOff="/icons/trailingOff.png" showIconTrailing="true"></Input>
